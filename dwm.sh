...
sudo pacman -S --noconfirm git base-devel xorg xorg-xinit alacritty rofi flameshot dunst picom feh thunar slstatus
...
# تحسين خط اللغة العربية
sudo pacman -S --noconfirm noto-fonts-cjk noto-fonts-emoji noto-fonts

echo "التثبيت والتكوين اكتمل. يمكنك الآن إعادة تشغيل النظام وبدء dwm."
